...
// Funções:
const { sendVideoAsSticker, sendImageAsSticker } = require('../../../yoko/bunker/sticker/rename.js');
const { sendVideoAsSticker2, sendImageAsSticker2 } = require('../../../yoko/bunker//sticker/rename2.js');
const { awaitMessage } = require('../../../yoko/bunker//funcoes/awaitMessage.js');
const { extractMetadata } = require('../../../yoko/bunker//funcoes/extractMetadata.js')
...
const { arcloud } = require('../../../yoko/bunker//js/arcc.js');
const { addBanned, unBanned, BannedExpired, cekBannedUser } = require("../../../yoko/bunker//js/banned.js");
const namoro1 = JSON.parse(fs.readFileSync("./yoko/bunker/database/func/namoro1.json"));
const namoro2 = JSON.parse(fs.readFileSync("./yoko/bunker/database/func/namoro2.json"));
const { validmove, setGame } = require('../../../yoko/bunker//tictactoe/index.js');
const { addComandosId, deleteComandos, getComandoBlock, getComandos, addComandos } =  require('../../../yoko/bunker//js/addcmd.js');
const { palavrasANA, quizanimais, enigmaArchive, garticArchives, whatMusicAr, quizFutebol } = require('../../../yoko/bunker//js/jogos.js');
const { wait, getExtension, generateMessageID, getMembros, getGroupAdmins, getRandom, banner, banner2, banner3, temporizador, chyt, getBuffer, fetchJson, fetchText, createExif, getBase64, convertSticker, upload, nit, getpc, supre, recognize } = require('../../../yoko/bunker//funcoes/functions.js'); // É necessário para algumas funções funcionar perfeitamente.
const { writeExifImg } = require('../../../yoko/bunker//sticker/exif.js')
const { writeExif2 } = require('../../../yoko/bunker//sticker/exif2.js')
const { isFiltered, addFilter } = require('../../../yoko/bunker//funcoes/functions.js');
// [JSON] - Funções Abaixo >>> :
const pushnames = JSON.parse(fs.readFileSync('./yoko/bunker/database/usuarios/users.json'));
const rgtake = JSON.parse(fs.readFileSync('./yoko/bunker/database/usuarios/take.json'));
const sotoy = JSON.parse(fs.readFileSync('./yoko/bunker//json/sotoy.json'));
const countMessage = JSON.parse(fs.readFileSync('./yoko/configs/media/countmsg.json'));
const comandos = JSON.parse(fs.readFileSync('./yoko/configs/media/comandos.json'));
const daily = JSON.parse(fs.readFileSync('./yoko/bunker/database/usuarios/diario.json'));
const nescessario = JSON.parse(fs.readFileSync('./yoko/configs/nescessario.json'));
const vip = JSON.parse(fs.readFileSync('./yoko/bunker/database/usuarios/vip.json'));
const ban = JSON.parse(fs.readFileSync('./yoko/bunker/database/usuarios/banned.json'));
const muted = JSON.parse(fs.readFileSync('./yoko/bunker/database/grupos/muted.json'))
const limitefll = JSON.parse(fs.readFileSync('./yoko/bunker/database/usuarios/flood.json'));
const joguinhodavelhajs = JSON.parse(fs.readFileSync('./yoko/bunker/database/usuarios/joguinhodavelha.json'));
const aluguel = JSON.parse(fs.readFileSync("./yoko/bunker/database/grupos/aluguel/aluguel.json"))
const grupos = JSON.parse(fs.readFileSync("./yoko/bunker/database/grupos/aluguel/grupos.json"))
const chaves = JSON.parse(fs.readFileSync("./yoko/bunker/database/grupos/aluguel/chaves.json"))
const joguinhodavelhajs2 = JSON.parse(fs.readFileSync('./yoko/bunker/database/usuarios/joguinhodavelha2.json'));
const antispam = JSON.parse(fs.readFileSync('./yoko/configs/media/antispam.json'));
const anotar = JSON.parse(fs.readFileSync("./yoko/bunker/database/func/anotar.json"));
const setting = JSON.parse(fs.readFileSync('./yoko/configs/settings.json'));
const logoslink = JSON.parse(fs.readFileSync('./yoko/configs/links_img.json'));
const Limit_CMD = JSON.parse(fs.readFileSync("./yoko/bunker/database/func/limitarcmd.json"))
const ftmenu = JSON.parse(fs.readFileSync("./yoko/configs/logos.json"));
const level2 = JSON.parse(fs.readFileSync("./yoko/bunker/database/usuarios/leveling.json"));
const tools = JSON.parse(fs.readFileSync('./yoko/bunker//json/tools.json'));
const advices = JSON.parse(fs.readFileSync('./yoko/bunker//json/advices.json'));

// Arquivos - JS - Menus / Informações:
const { linguagem, mess, getInfo } = require('../lib/index.js');
const { psycatgames, vyroEngine } = require('../../../yoko/bunker//funcoes/scrapper.js');
const { destrava, destrava2 } = require('../../../yoko/bunker//funcoes/destrava.js');
const { tabela } = require('../../../yoko/bunker//js/tabela.js');
