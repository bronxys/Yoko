...
exports.fetchJson2 = fetchJson2 = (url, options) => new Promise(async (resolve, reject) => {
...
await sleepy(4000)
const buffer5 = await fs.readFileSync(`./XeonMedia/trash/${filename}.mp4`)
await Promise.all([
...
fetchJson2: exports.fetchJson2,
fetchBuffer: exports.fetchBuffer,
getBuffer: exports.getBuffer,
webp2mp4File: exports.webp2mp4File,
fetchUrl: exports.fetchUrl,
WAVersion: exports.WAVersion,
getRandom: exports.getRandom,
isUrl: exports.isUrl,
isNumber: exports.isNumber,
TelegraPh: exports.TelegraPh,
buffergif: exports.buffergif
}