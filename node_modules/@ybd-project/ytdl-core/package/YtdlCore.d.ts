import type { YTDL_Constructor, YTDL_DownloadOptions, YTDL_GetInfoOptions, YTDL_VideoInfo, YTDL_ProxyOptions, YT_StreamingAdaptiveFormat } from './types';
...
declare class YtdlCore {
    ...
    static decipherFormat: (format: YT_StreamingAdaptiveFormat) => Promise<YT_StreamingAdaptiveFormat | null>;
