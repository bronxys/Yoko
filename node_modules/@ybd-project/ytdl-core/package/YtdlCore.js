...
class YtdlCore {
    ...
    /* Setup */
    async init({ disableInitialSetup, poToken, visitorData, oauth2Credentials }, requestInit = {}) {
    ...
    async initializeHtml5PlayerCache() {
        const HTML5_PLAYER = await FileCache.get('html5Player');
        if (!HTML5_PLAYER) {
...
YtdlCore.decipherFormat = function (format) {
    return new Promise(async (resolve) => {
        const HTML5_PLAYER_DATA = await (0, Html5Player_1.getHtml5Player)({});
