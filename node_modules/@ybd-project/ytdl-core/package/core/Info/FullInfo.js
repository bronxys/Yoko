...
async function _getFullInfo(id, options) {
    const HTML5_PLAYER_PROMISE = (0, Html5Player_1.getHtml5Player)(options), BASIC_INFO = await (0, BasicInfo_1._getBasicInfo)(id, options, true), INFO = Object.assign({}, BASIC_INFO), FUNCTIONS = [], HTML5_PLAYER = await HTML5_PLAYER_PROMISE;
